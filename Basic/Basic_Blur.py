'''
This code is to see the effect of various types of blur in a image
...
cv2.createTrackbar('Kernel','PARAMETERS',2,20,nothing)
k = 0

while(k!=27):
    x = cv2.getTrackbarPos('Kernel','PARAMETERS')
    if x<2: x=2
